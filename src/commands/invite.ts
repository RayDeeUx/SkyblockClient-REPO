...
export default class invite extends BotCommand {
    ...
    async exec(message, args) {
        if (message.interaction) {
            return await message.reply({content:'[https://discord.com/api/oauth2/authorize?client_id=826247426922250280&permissions=8&scope=bot%20applications.commands](https://www.youtube.com/watch?v=dQw4w9WgXcQ)', ephemeral:args.ephemeral})
        }
